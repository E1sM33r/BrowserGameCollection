...
@section('content')
    <div class="flex justify-center">
        <div class="2xl:w-2/6 xl:w-3/6 lg:w-3/6 md:w-4/6 sm:w-10/12 bg-gray-200 p-6 rounded-lg" x-data="{showDeleteModal:false}" x-bind:class="{ 'model-open': showDeleteModal }">
